...
@media (max-width: 768px) {
    .sidebar { position: fixed; left: 0; top: 0; bottom: 0; transform: translateX(-100%); transition: transform var(--anim-normal) var(--anim-easing); z-index: 60; }
    .sidebar.open { transform: translateX(0); }
    .chat-area { padding: var(--space-md) var(--space-md) var(--chat-bottom-pad); }
    .composer-dock { width: calc(100% - var(--space-xl)); bottom: var(--space-md); }
}
"""
