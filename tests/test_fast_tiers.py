...
Fast = Gemini 3.1 Flash Lite -> Nemotron Ultra (Ollama VL 3B
...
SYNTHESIS_TIERS + escape hatch, Ollama VL 3B at the tail as well).
"""
...
def test_fast_tiers_shape():
    ...
    assert "Ollama VL 3B" not in names  # deep-only offline tail
